...
function visitedArguments(context) {
  ...
  this.oncall(context.callee, context.context, args, recurses)
  context.args = args
...
function oncalled(context) {
  this.oncalled(context.callee, context.context, context.args, context.recurses, this._valueStack.current())
}
