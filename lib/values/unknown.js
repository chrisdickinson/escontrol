...
function Unknown(builtins, parentMap) {
  ObjectValue.call(this, builtins, hidden.initial.UNKNOWN, null, parentMap)
...
proto.copy = function Unknown_copy() {
  var copy = new Unknown(this._builtins, this._attributes)
